...
function GOOGLEDISTANCE(
    ...
    if (directions.status !== "OK") return "Error: " + directions.status;
...
function GETADDRESS(zipcode) {
    ...
    var apiUrl = "http://api.zippopotam.us/us/" + zipcode;
    ...
    try {
        ...
        // If there's any error or the ZIP code isn't found
        return "ZIP code not found or error occurred.";
    }
}
